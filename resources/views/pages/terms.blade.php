...
@section('content')
    <div class="Site-content">
        <div class="Container">
            <h2>Terms of use</h2>
            Last updated: 21 februari 2016<br>
            Please read these Terms of Use carefully before using the website.<br>
            ...
            any part of the terms then you may not access the Service.<br>
            Termination clause for websites that do not have accounts. If your website or mobile app allows
            users to register and have an account, create your own Terms of Use.
            <h3>Termination</h3>
            ...
            by Team A.<br>
            Team A has no control over, and assumes no responsibility for, the
            content, privacy policies, or practices of any third party web sites or services. You further
            acknowledge and agree that Team A shall not be responsible or liable,
            ...
            <h3>Governing Law</h3>
            These Terms shall be governed and construed in accordance with the laws of The Netherlands, without regard to its conflict of law provisions.<br>
